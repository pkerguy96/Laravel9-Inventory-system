...
class OrderFormController extends Controller
{
    public function AllOrderForms()
    {
        try {
            ...
            Log::error('AllOrderForms function: ' . $e->getMessage());
            report($e);
            abort(404);
        }
    }
    public function AddOrderForm()
    {
        try {
            ...
            Log::error('AddOrderForm function: ' . $e->getMessage());
            report($e);
            abort(404);
        }
    }
    public function StoreOrderForm(Request $request)
    {
        try {
            ...
            Log::error('StoreOrderForm function: ' . $e->getMessage());
            report($e);
            abort(404);
        }
    }
    public function OrderFormDetails($id)
    {
        try {
            ...
            Log::error('OrderFormDetails function: ' . $e->getMessage());
            report($e);
            abort(404);
        }
    }
