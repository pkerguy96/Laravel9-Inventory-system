                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div
                                class="row justify-content-center justify-content-md-center justify-content-sm-between gap-sm-3 gap-md-5 flex-wrap">
                                <div class="col-md-2 col-sm-12 mb-3 mb-sm-0">
                                    <div class="md-3">
                                        <label for="example-text-input" class="form-label"
                                            style="white-space: nowrap;">{{ __('Invoice Number') }}</label>
                                        <input class="form-control" type="text" value="{{ $quotation_no }}"
                                            name="quotation_no" id="quotation_no" readonly style="background-color: #ddd;">
                                    </div>
                                </div>
                                <div class="col-md-2 col-sm-12 mb-3 mb-sm-0">
                                    <div class="md-3">
                                        <label for="example-text-input" class="form-label">{{ __('Date') }}</label>
                                        <input class="form-control lowl " type="date" value="{{ $date }}"
                                            name="date" id="date">
                                    </div>
                                </div>
                                <div class="col-md-2 col-sm-12">
                                    <div class="md-3">
                                        ...
                                        <input class="form-control tani" type="date" value="{{ $date }}"
                            ...
                            <div class="row d-flex justify-content-center  mt-2 mt-sm-1 mt-md-2 mt-lg-3 mt-xl-3 flex-wrap">
                                ...
                                <div class="col-md-2 col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" name="stock_qte" id="stock_qte" readonly
                            ...
                            <div class="row float-end mt-0 ">
                                ...
                                <div class="col-md-12">
                                    <div class="md-3">
                                        <label for="example-text-input" class="form-label"
                                            style="margin-top: 32px;"></label>

                                        <i
                                            class="btn btn-info   btn-rounded waves-effect waves-light fas fa-plus-circle eeventmore">
                                            {{ __('Add More') }}</i>
                                    </div>
                                </div>
                            ...
                            <form action="{{ route('store.quotation') }}" method="post" action="">
                                    ...
                                    <table class="table-sm table-bordered" width="100%" style="border-color:#ddd ;">
                                        ...
                                        <tr>
                                            <td colspan="5" style="text-align: right;"><strong
                                                    class="text-right">{{ __('Discount') }} </strong></td>
                                            <td>
                                                <input type="text" name="discount_amount" id="discount_amount"
                                                    class="form-control" placeholder="{{ __('Discount Amount') }}">
                                            </td>
                                            <td></td>
                                        </tr>
                                        <tbody id=" rowAdd" class="rowAdd">
                                            <tr>
                                                <td colspan="5" style="text-align: right;"> <strong
                                                        class="text-right">{{ __('Subtotal') }}</strong></td>

                                                <td>
                                                    <input type="text" name="amount" value="0" id="amount"
                                                        class="form-control amount" readonly
                                                        style="background-color: #ddd;">
                                                    <input type="hidden" name="amountrd" id="amountrd"
                                                        class="amountrd">
                                                </td>
                                                <td></td>
                                            </tr>
                                            <tr>
                                                <td colspan="5" style="text-align: right;"> <strong
                                                        class="text-right">{{ __('Tax') }} 20%</strong></td>


                                                <td>
                                                    <input type="text" name="tax" value="0" id="tax"
                                                        class="form-control amount" readonly
                                                        style="background-color: #ddd;">
                                            ...
                                            <tr>
                                                <td colspan="5" style="text-align: right;"><strong
                                                        class="text-right">{{ __('Grand Total estimated amount') }}</strong>
                                                </td>
                                                <td>
                                                    <input type="text" name="Gtotal" value="0" id="Gtotal"
                                                        class="form-control Gtotal" readonly
                                                        style="background-color: #ddd;">
                                                </td>
                                                <td></td>
                                            </tr>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        <textarea name="description" class="form-control" id="description"
                                            placeholder="{{ __('Enter description here') }}"></textarea>
                                    </div>
                                </div><br>
                                <div class="row">
                                    <div class="form-group col-md-12">
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-info"
                                        id="addButton">{{ __('Add Quotation') }}</button>
                                </div>
                            </form>
