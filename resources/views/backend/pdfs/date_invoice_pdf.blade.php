...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Invoice Report By Date</h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);"></a></li>
                    <li class="breadcrumb-item active">Invoice Report By Date</li>
                </ol>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-12">
                        <div>
                            <div class="p-2">
                                <h3 class="font-size-16"><strong>Invoices Date Report <span class="btn btn-info">{{date('d-m-Y',strtotime($startdate))}}</span>-- <span class="btn btn-success">{{date('d-m-Y',strtotime($enddate))}}</span></strong></h3>
                            </div>
