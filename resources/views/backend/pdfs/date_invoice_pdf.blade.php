                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div>
                                <div class="p-2">
                                    <h3 class="font-size-16"><strong>{{ __('Invoices Date Report') }}<span
                                                ...
                                                @foreach ($data as $key => $item)
                                                    <tr>
                                                        <td class="text-center"><a
                                                                href="{{ route('Print.invoice.client', $item->id) }}"
                                                                class="text-reset !important">{{ $key + 1 }} </a></td>
                                                        <td class="text-center"><a
                                                                href="{{ route('Print.invoice.client', $item->id) }}"
                                                                class="text-reset !important">{{ $item['payements']['customers']['name'] }}</a>
                                                        </td>
                                                        <td class="text-center"><a
                                                                href="{{ route('Print.invoice.client', $item->id) }}"
                                                                class="text-reset !important">{{ $item->invoice_no }}</a>
                                                        </td>

                                                        <td class="text-center"><a
                                                                href="{{ route('Print.invoice.client', $item->id) }}"
                                                                class="text-reset !important">{{ date('d-m-Y', strtotime($item->date)) }}</a>
                                                        </td>
                                                        <td class="text-center"><a
                                                                href="{{ route('Print.invoice.client', $item->id) }}"
                                                                class="text-reset !important">{{ $item->description }}</a>
                                                        </td>
                                                        <td class="text-center"><a
                                                                href="{{ route('Print.invoice.client', $item->id) }}"
                                                                class="text-reset !important">
