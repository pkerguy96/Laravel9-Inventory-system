                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div>
                                <div class="p-2">
                                    <h3 class="font-size-16"><strong>{{ __('Purchases Details Date') }} <span
                                                class="btn btn-light">{{ date('d-m-Y', strtotime($data->date)) }}</span></strong>
                                    </h3>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="">
                                        ...
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <td class="text-center"><strong>{{ __('Product Category') }}</strong>
                                                    </td>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{ $data['brands']['Brand_name'] ?? 'N/A' }}
                                                    </td>
                                                    <td class="text-center">
                                                        {{ $data['categories']['category_name'] ?? 'N/A' }}</td>
                                                    <td class="text-center">
                                                        {{ $data['products']['product_name'] ?? 'N/A' }}</td>
                                    ...
                                    <div class="card card-body">
                                        ...
                                        <h5 class="text-center">{{ __('Total amount is') }} : <b>{{ $amountInWords }}
                                                MAD</b></h5>
