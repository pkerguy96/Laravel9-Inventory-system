    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">{{ __('Customer Wise Credit Report') }}</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);"></a></li>
                        <li class="breadcrumb-item active">{{ __('Customer Wise Credit Report') }}</li>
                    </ol>
                </div>
                                        ...
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <td class="text-center"><strong>{{ __('Due Amount') }}</strong></td>
                                                    </td>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($data as $key => $item)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            {{ date('d-m-Y', strtotime($item['Invoices']['date'])) }}</td>
                                                        <td class="text-center">
                                                            {{ number_format($item->due_amount, 2, '.', ',') }} MAD</td>
                                                    </tr>
                                                    @php
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="no-line text-center">
                                                        <strong>{{ __('Grand Due Total') }}</strong>
                                                    </td>
