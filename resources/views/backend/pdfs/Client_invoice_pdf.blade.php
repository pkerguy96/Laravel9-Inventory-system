                            ...
                            <div class="col-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 mt-4 text-end">
                                        <address>
                                            <h5>{{ __('Invoice Number') }}: {{ $invoice->invoice_no }}</h5>
                                            <strong>{{ __('Due Date') }}:
                                                {{ date('d-m-Y', strtotime($invoice->date)) }}</strong><br>
                                            <strong>{{ __('Order Date') }}:
                                                {{ date('d-m-Y', strtotime($invoice->due_date)) }}</strong><br>
                                            <strong>{{ __('Delivery Receipt') }}:
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody id="body">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="no-line text-end">{{ $invoice->tax_rate }}%</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="no-line"></td>
                                                        <td class="no-line"></td>
