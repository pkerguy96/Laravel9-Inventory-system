                                        ...
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <td class="text-center"><strong>{{ __('Supplier Name') }}</strong></td>
                                                    <td class="text-center"><strong>{{ __('Category') }}</strong></td>
                                                    <td class="text-center"><strong>{{ __('Unit') }}</strong></td>
                                                    <td class="text-center"><strong>{{ __('Reference Number') }}</strong>
                                                    </td>
                                                    <td class="text-center"><strong>{{ __('Product Name') }}</strong></td>
                                                    <td class="text-center"><strong>{{ __('Bought Quantity') }}</strong>
                                                    </td>
                                                    <td class="text-center"><strong>{{ __('Sold Quantity') }}</strong></td>
                                                    <td class="text-center"><strong>{{ __('Product Quantity') }}</strong>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($data as $key => $item)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">{{ $item['suppliers']->name ?? 'deleted' }}
                                                        </td>
                                                        <td class="text-center">{{ $item['categories']->category_name }}
                                                        </td>
                                                        ...
                                                        <td class="text-center"> <span
                                                                class="btn btn-info">{{ $bought_qte }}</span> </td>
                                                        <td class="text-center"> <span
                                                                class="btn btn-success">{{ $sold_qte }}</span> </td>
                                                        <td class="text-center"><span
                                                                class="btn btn-warning">{{ $item->product_qte }}</span>
                                                        </td>
