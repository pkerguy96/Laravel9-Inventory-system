                                            ...
                                            <table class="table">
                                                ...
                                                <tbody id="body">
                                                    ...
                                                    <tr class="to-keep">
                                                        ...
                                                        <td class="to-keep text-center">
                                                            {{ number_format($deliverydetail->unit_price, 2, '.', ',') }}
                                                            MAD
                                                        </td>
                                                        <td class="to-keep text-center">
                                                    ...
                                                    $Grand_total = CalculateGrandTotal($sellingPrices, $data->discount, $data->tax_rate);
                                                    @endphp
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="no-line text-center"><b> {{ $data->tax_rate }}%</b></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="no-line"></td>
                                                        <td class="no-line"></td>
