                                ...
                                <div class="col-md-4">
                                    <div class="md-3">
                                        <label for="example-text-input"
                                            class="form-label">{{ __('Purchase Number') }}</label>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="md-3">
                                        ...
                                        <i
                                            class="btn btn-info btn-rounded waves-effect waves-light fas fa-plus-circle eeventmore float-right">
                                            {{ __('Add More') }}</i>
                                    </div>
                                </div>
                            </div>
                            ...
                            <form action="{{ route('store.purchase') }}" method="post" action="">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="amount" value="0" id="amount"
                                                    class="form-control amount" readonly style="background-color: #ddd;">
                                            </td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-info"
                                        id="addButton">{{ __('Add Purchase') }}</button>
                                </div>
                            </form>
