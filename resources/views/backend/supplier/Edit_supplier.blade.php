                        ...
                        <form method="post" action="{{ route('modify.supplier') }}" id="myForm">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-10">
                                    <input name="name" class="form-control" type="text" value="{{$supplierinfo->name}}">
                                </div>
                            </div>
                            <!-- end row -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-10">
                                    <input name="phone" class="form-control" type="text" value="{{$supplierinfo->phone}}">
                                </div>
                            </div>
                            <!-- end row -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-10">
                                    <input name="email" class="form-control" type="email" value="{{$supplierinfo->email}}">
                                </div>
                            </div>
                            <!-- end row -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-10">
                                    <input name="address" class="form-control" type="text" value="{{$supplierinfo->address}}">
                                </div>
                            </div>
                            <!-- end row -->


                            <input type="submit" class="btn btn-info waves-effect waves-light" value="Modify Supplier">
                        </form>
