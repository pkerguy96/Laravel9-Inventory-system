            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">{{ __('Supplier And Product Report') }}</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    <strong>{{ __('Supplier Report') }}</strong>
                                    <input type="radio" name="supplier_info" id="supplier_info" value='supplier_true'
                                        class="search_value">&nbsp;&nbsp;
                                    <strong>{{ __('Product Report') }}</strong>
                                    <input type="radio" name="supplier_info" id="product_info" value='product_true'
                                        class="search_value">
                                </div>
                            </div>
                            <div class="supplier_list" style="display: none;">
                                <form action="{{ route('supplier.report.pdf') }}" method="GET" id="promform"
                                    target="_blank">
                                    <div class="row">
                            ...
                            <div class="product_list" style="display: none;">
                                <form action="{{ route('product.report.pdf') }}" method="GET" id="promform"
                                    target="_blank">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="md-3">
                                        ...
                                        <div class="col-md-4">
                                            <div class="md-3">
                                                <label for="example-text-input"
                                                    class="form-label">{{ __('Product Name') }}</label>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#promform').validate({
                ...
                messages: {
                    supplier_id: {
                        required: "{{ __('Please Select A Supplier') }}",
                    },
    ...
    <script type="text/javascript">
        ...
        function fetchProducts(category_id) {
            fetch(`{{ route('fetch-product') }}?category_id=${category_id}`, {
                ...
                .then(data => {
                    let html = "<option value=\"\">{{ __('Select Category') }}</option>";
