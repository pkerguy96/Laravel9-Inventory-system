            ...
            <div class=" col-md-8">
                ...
                <div class="card">
                    <div class="card-header border-primary d-flex justify-content-between">
                        <h5 class="my-0 text-primary"><i class="mdi mdi-bullseye-arrow me-3"></i>{{ $notification->type }}</h5>
                        <button type="button" class="btn-close " data-attr-NotifyID="{{$notification->id}}" onclick="DeleteNotificationDOM(this,event)"></button>
                    </div>
                    <div class="card-body">
                        <div class="card-title">{{ $notification->message }}</div>
                        <p class="card-text">Only {{ $notification['products']['product_qte']  }} Are Left </p>
    ...
    <div class="container-fluid">
        <div class="card mt-5">
            <div class="card-body ">
                ...
                <p class="card-text text-center">No New Notification Available</p>
